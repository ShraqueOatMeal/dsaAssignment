...
int quickSort::partition(transactions *transArray, int low, int high) {
    string pivotDate = transArray[high].date; // Assuming 'date' is a string in DD/MM/YYYY
    int i = low - 1;
...
// QuickSort for array
void quickSort::quickSortTransactions(transactions *transArray, int low, int high) {
    if (low < high) {
...
Node<transactions>* quickSort::partition(Node<transactions>* low, Node<transactions>* high, Node<transactions>** newLow, Node<transactions>** newHigh) {
...
void quickSort::quickSortLinkedList(Node<transactions>* low, Node<transactions>* high) {
