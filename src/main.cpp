...
//         break;
//       case 2:
//         // quickSort::displaySortedByDate(transactionList);
//         break;
//       case 3: {
...
//         break;
//       case 2:
//         // quickSort::displaySortedByDate(mergedList);
//         break;
//       case 3: {
//         auto start = chrono::high_resolution_clock::now();
...
//       switch (sortChoice) {
//       case 1:
//           bubblesort::displaySortedByDate(transArray, transCount);  // Note: This seems incorrect in original; should
//                               // be transArray
//         break;
//       case 2:
//         // quickSort::displaySortedByDate(transArray);
//         break;
//       case 3: {
//         auto start = chrono::high_resolution_clock::now();
...
//       switch (sortChoice) {
//       case 1:
//         // bubblesort::displaySortedByDateA(mergedData* arr, int size) // Adjust as needed
//         break;
//       case 2:
...
//   cout << "\nChoose a search algorithm:" << endl;
...
//       jumpSearch jsInstance;
//       jsInstance.searchMenu(transactionList, catChoice, paymentChoice);
//     } else {
...
//     } else if (searchAlgo == 2) {
//       jumpSearch jsInstance;
//       jsInstance.searchMenu(transArray, transCount, catChoice, paymentChoice);
//     } else {
//       cout << "Invalid search algorithm." << endl;
//     }
//   }
